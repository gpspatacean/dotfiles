      ...
      require("nvim-treesitter.configs").setup({
        ...
        textobjects = {
          ...
          swap = {
            enable = true,
            swap_next = {
              ["<leader>na"] = { query = "@parameter.inner", desc = "Swap parameter/argument with the next one" },
              ["<leader>n:"] = { query = "@property.outer", desc = "Swap object property with the next one" },
            ...
            swap_previous = {
              ...
              ["<leader>p:"] = { query = "@property.outer", desc = "Swap object property with the previous one" },
